...
export type SyntaxTriviaTokenKind = SyntaxTokenKind.NEWLINE | SyntaxTokenKind.SPACE | SyntaxTokenKind.TAB | SyntaxTokenKind.SINGLE_LINE_COMMENT | SyntaxTokenKind.MULTILINE_COMMENT;  
